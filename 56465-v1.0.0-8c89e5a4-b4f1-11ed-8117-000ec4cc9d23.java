...
public class CWE606_Unchecked_Loop_Condition__URLConnection_52a extends AbstractTestCase
{
    ...
    public void bad() throws Throwable
    {
        ...
        (new CWE606_Unchecked_Loop_Condition__URLConnection_52b()).bad_sink(data );
    }
    ...
    private void goodG2B() throws Throwable
    {
        ...
        (new CWE606_Unchecked_Loop_Condition__URLConnection_52b()).goodG2B_sink(data );
    }
    ...
    private void goodB2G() throws Throwable
    {
        ...
        (new CWE606_Unchecked_Loop_Condition__URLConnection_52b()).goodB2G_sink(data );
    }
